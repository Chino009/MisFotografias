        ...
        binding.btnUpload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (photoSelectedUri == null) {
                    Snackbar.make(binding.container, "selecciona una imagen de la galeria", BaseTransientBottomBar.LENGTH_LONG).show();
                    return;
                }
                StorageReference profileReference = storageReference.child(PATH_PROFILE);
                StorageReference photoReference = profileReference.child(MI_PHOTO);
